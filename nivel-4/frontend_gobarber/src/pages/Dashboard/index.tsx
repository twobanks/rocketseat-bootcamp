...
import { Container, Header, HeaderContent, Profile, Content, Schedule, NextAppointment, Section, Appointment, Calendar } from './style';
...
const Dashboard: React.FC = () => {
      ...
      useEffect(() => {
            api.get<Appointment[]>('/appointments/me', {
                  params: {
                        year: selectDate.getUTCFullYear(),
            ...
            <Container>
                  <Header>
                        <HeaderContent>
                              ...
                              <Profile>
                                    <img src={"https://avatars1.githubusercontent.com/u/2577611?s=460&u=118117a943294dfb5fb7e4050061133cf7476329&v=4"} alt={user.name} />
                                    <div>
                                          <span>Bem-vindo,</span>
